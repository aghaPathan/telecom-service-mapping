...
type LevelMeta = { label: string; cls: string; dot: string };
...
export function LevelBadge({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 rounded-none px-2 py-[3px] font-mono text-[10px] font-medium uppercase tracking-widest ring-1 ring-inset ${meta.cls} ${className}`.trim()}
